...
public final class MultilineTicketSearchResponseParser implements RTParser {
	...
	public List<Map<String, String>> parseTicketSearchResponse(String responseBody) {
		return(this.parseResponse(responseBody));
	}
	...
	public List<Map<String, String>> parseResponse(String response) {
		...
		for (String ticketString : response.split(DELIMITER_TICKETS)) {
